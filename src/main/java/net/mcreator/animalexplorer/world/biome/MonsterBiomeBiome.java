...
package net.mcreator.animalexplorer.world.biome;
...
public class MonsterBiomeBiome extends AnimalexplorerModElements.ModElement {
	public static Biome biome;
	public MonsterBiomeBiome(AnimalexplorerModElements instance) {
		super(instance, 69);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(10387789).withGrassColor(-14793960).build();
				...
				event.getRegistry().register(biome.setRegistryName("animalexplorer:monster_biome"));
			}
		}
	}
	@Override
