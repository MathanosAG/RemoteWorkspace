...
public class SharkToothItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:shark_tooth")
	public static final Item block = null;
	public SharkToothItem(AnimalexplorerModElements instance) {
		super(instance, 37);
	}
