...
public class LionFurItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:lion_fur")
	public static final Item block = null;
	public LionFurItem(AnimalexplorerModElements instance) {
		super(instance, 34);
	}
