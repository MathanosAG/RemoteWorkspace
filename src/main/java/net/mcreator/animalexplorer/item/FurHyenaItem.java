...
public class FurHyenaItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:fur_hyena")
	public static final Item block = null;
	public FurHyenaItem(AnimalexplorerModElements instance) {
		super(instance, 61);
	}
