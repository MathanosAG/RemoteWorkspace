...
public class GeckoScaleItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:gecko_scale")
	public static final Item block = null;
	public GeckoScaleItem(AnimalexplorerModElements instance) {
		super(instance, 45);
	}
