...
public class FeatherPenguinItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:feather_penguin")
	public static final Item block = null;
	public FeatherPenguinItem(AnimalexplorerModElements instance) {
		super(instance, 28);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("feather_penguin");
		}
