...
public class HornElephantItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:horn_elephant")
	public static final Item block = null;
	public HornElephantItem(AnimalexplorerModElements instance) {
		super(instance, 15);
	}
