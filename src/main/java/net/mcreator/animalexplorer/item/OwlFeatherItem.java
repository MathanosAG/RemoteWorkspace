...
public class OwlFeatherItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:owl_feather")
	public static final Item block = null;
	public OwlFeatherItem(AnimalexplorerModElements instance) {
		super(instance, 58);
	}
