...
import net.mcreator.animalexplorer.procedures.GeckoBootsTickEventProcedure;
...
public class GeckoItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:gecko_helmet")
	public static final Item helmet = null;
	@ObjectHolder("animalexplorer:gecko_chestplate")
	public static final Item body = null;
	@ObjectHolder("animalexplorer:gecko_leggings")
	public static final Item legs = null;
	@ObjectHolder("animalexplorer:gecko_boots")
	public static final Item boots = null;
	public GeckoItem(AnimalexplorerModElements instance) {
		super(instance, 46);
	}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(AnimalExploItemGroup.tab)) {
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				double z = entity.getPosZ();
				{
					...
					GeckoBootsTickEventProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("gecko_boots"));
	}
}
