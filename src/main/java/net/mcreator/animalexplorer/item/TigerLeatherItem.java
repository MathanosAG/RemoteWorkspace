...
public class TigerLeatherItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:tiger_leather")
	public static final Item block = null;
	public TigerLeatherItem(AnimalexplorerModElements instance) {
		super(instance, 24);
	}
