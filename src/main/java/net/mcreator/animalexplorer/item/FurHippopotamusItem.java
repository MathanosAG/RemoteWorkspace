...
public class FurHippopotamusItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:fur_hippopotamus")
	public static final Item block = null;
	public FurHippopotamusItem(AnimalexplorerModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fur_hippopotamus");
		}
