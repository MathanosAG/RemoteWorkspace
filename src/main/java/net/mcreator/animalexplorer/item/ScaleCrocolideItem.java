...
public class ScaleCrocolideItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:scale_crocolide")
	public static final Item block = null;
	public ScaleCrocolideItem(AnimalexplorerModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("scale_crocolide");
		}
