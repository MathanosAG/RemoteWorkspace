...
import net.mcreator.animalexplorer.procedures.OwlHelmetHelmetTickEventProcedure;
...
public class OwlHelmetItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:owl_helmet_helmet")
	public static final Item helmet = null;
	@ObjectHolder("animalexplorer:owl_helmet_chestplate")
	public static final Item body = null;
	@ObjectHolder("animalexplorer:owl_helmet_leggings")
	public static final Item legs = null;
	@ObjectHolder("animalexplorer:owl_helmet_boots")
	public static final Item boots = null;
	public OwlHelmetItem(AnimalexplorerModElements instance) {
		super(instance, 59);
	}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AnimalExploItemGroup.tab)) {
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				double z = entity.getPosZ();
				{
					...
					OwlHelmetHelmetTickEventProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("owl_helmet_helmet"));
	}
}
