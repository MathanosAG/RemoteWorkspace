...
public class CherriesItem extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:cherries")
	public static final Item block = null;
	public CherriesItem(AnimalexplorerModElements instance) {
		super(instance, 19);
	}
