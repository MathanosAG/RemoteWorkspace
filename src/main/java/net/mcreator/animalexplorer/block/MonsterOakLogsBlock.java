...
import net.mcreator.animalexplorer.procedures.MonsterOakLogsOnBlockRightClickedProcedure;
...
public class MonsterOakLogsBlock extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:monster_oak_logs")
	public static final Block block = null;
	public MonsterOakLogsBlock(AnimalexplorerModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(7f, 16f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("monster_oak_logs");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				MonsterOakLogsOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
