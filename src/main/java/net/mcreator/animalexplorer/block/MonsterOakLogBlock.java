...
import net.mcreator.animalexplorer.procedures.MonsterOakLogOnBlockRightClickedProcedure;
...
public class MonsterOakLogBlock extends AnimalexplorerModElements.ModElement {
	@ObjectHolder("animalexplorer:monster_oak_log")
	public static final Block block = null;
	public MonsterOakLogBlock(AnimalexplorerModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("monster_oak_log");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				MonsterOakLogOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
