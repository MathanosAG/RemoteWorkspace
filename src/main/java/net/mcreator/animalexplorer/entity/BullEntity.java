...
import net.mcreator.animalexplorer.procedures.BullEntityDiesProcedure;
import net.mcreator.animalexplorer.itemgroup.AnimalExploItemGroup;
import net.mcreator.animalexplorer.entity.renderer.BullRenderer;
...
public class BullEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.2000000000000002f, 1.5f)).build("bull").setRegistryName("bull");
	public BullEntity(AnimalexplorerModElements instance) {
		super(instance, 12);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BullRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15856114, -13553616, new Item.Properties().group(AnimalExploItemGroup.tab))
				.setRegistryName("bull_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 1000, 1, 4));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(8, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.WHEAT, (int) (1)).getItem()), false));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BullEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
