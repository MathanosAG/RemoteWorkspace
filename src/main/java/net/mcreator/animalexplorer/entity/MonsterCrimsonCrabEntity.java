...
import net.mcreator.animalexplorer.procedures.MonsterCrimsonCrabEntityDiesProcedure;
import net.mcreator.animalexplorer.itemgroup.AnimalExploItemGroup;
import net.mcreator.animalexplorer.entity.renderer.MonsterCrimsonCrabRenderer;
...
public class MonsterCrimsonCrabEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1f, 1.4f)).build("monster_crimson_crab").setRegistryName("monster_crimson_crab");
	public MonsterCrimsonCrabEntity(AnimalexplorerModElements instance) {
		super(instance, 50);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MonsterCrimsonCrabRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7992308, -4570352, new Item.Properties().group(AnimalExploItemGroup.tab))
				.setRegistryName("monster_crimson_crab_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 850, 1, 1));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, MonsterWarpedRatEntity.CustomEntity.class, true, false));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				MonsterCrimsonCrabEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
