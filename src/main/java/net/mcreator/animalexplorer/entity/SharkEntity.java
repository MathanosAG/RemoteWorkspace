...
import net.mcreator.animalexplorer.procedures.SharkEntityDiesProcedure;
import net.mcreator.animalexplorer.itemgroup.AnimalExploItemGroup;
import net.mcreator.animalexplorer.item.SharkToothItem;
import net.mcreator.animalexplorer.entity.renderer.SharkRenderer;
...
public class SharkEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(2f, 0.8f)).build("shark").setRegistryName("shark");
	public SharkEntity(AnimalexplorerModElements instance) {
		super(instance, 36);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15527122, -12698290, new Item.Properties().group(AnimalExploItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 512, 1, 2));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MOVEMENT_SPEED, 1.2000000000000002);
			...
			ammma = ammma.createMutableAttribute(ForgeMod.SWIM_SPEED.get(), 1.2000000000000002);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, CodEntity.class, true, false));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, DolphinEntity.class, true, false));
			...
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, SalmonEntity.class, true, false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SharkToothItem.block, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				SharkEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
