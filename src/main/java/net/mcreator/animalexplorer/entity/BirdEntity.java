...
import net.mcreator.animalexplorer.entity.renderer.BirdRenderer;
import net.mcreator.animalexplorer.AnimalexplorerModElements;

import java.util.Random;

@AnimalexplorerModElements.ModElement.Tag
public class BirdEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.5f)).build("bird").setRegistryName("bird");
	public BirdEntity(AnimalexplorerModElements instance) {
		super(instance, 47);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -13430784, new Item.Properties().group(AnimalExploItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 90, 1, 5));
	}
