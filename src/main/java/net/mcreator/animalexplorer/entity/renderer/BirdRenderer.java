...
import net.mcreator.animalexplorer.entity.BirdEntity;
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BirdEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBird(), 0.2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/bird.png");
					}
				};
			});
		}
