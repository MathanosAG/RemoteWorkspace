...
@OnlyIn(Dist.CLIENT)
public class GeckoRedRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GeckoRedEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgecko(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/gecko_red.png");
					}
				};
			});
		}
