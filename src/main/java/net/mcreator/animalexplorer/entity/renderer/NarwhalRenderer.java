...
import net.mcreator.animalexplorer.entity.NarwhalEntity;
...
public class NarwhalRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NarwhalEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnarwhal(), 1f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/narval.png");
					}
				};
			});
		}
