...
@OnlyIn(Dist.CLIENT)
public class GeckoYellowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GeckoYellowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgecko(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/gecko_yellow.png");
					}
				};
			});
		}
