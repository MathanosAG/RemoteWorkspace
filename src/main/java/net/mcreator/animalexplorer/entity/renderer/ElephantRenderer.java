...
import net.mcreator.animalexplorer.entity.ElephantEntity;
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ElephantEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelelephant(), 2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/elephant.png");
					}
				};
			});
		}
