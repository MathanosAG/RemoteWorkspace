...
import net.mcreator.animalexplorer.entity.MonsterWarpedRatEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class MonsterWarpedRatRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MonsterWarpedRatEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwarped_rat_monster(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/warped_rat_monster.png");
					}
				};
			});
		}
