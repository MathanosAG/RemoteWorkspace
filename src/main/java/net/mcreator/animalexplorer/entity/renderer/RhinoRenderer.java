...
import net.mcreator.animalexplorer.entity.RhinoEntity;
...
public class RhinoRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RhinoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRhino(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/rhino.png");
					}
				};
			});
		}
