...
import net.mcreator.animalexplorer.entity.LionEntity;
...
public class LionRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LionEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnewlion(), 0.7999999999999999f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("animalexplorer:textures/newlion.png");
					}
				};
			});
		}
