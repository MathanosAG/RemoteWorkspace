...
import net.mcreator.animalexplorer.entity.renderer.HyenaRenderer;
import net.mcreator.animalexplorer.AnimalexplorerModElements;

@AnimalexplorerModElements.ModElement.Tag
public class HyenaEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1f, 1.0999999999999999f)).build("hyena").setRegistryName("hyena");
	public HyenaEntity(AnimalexplorerModElements instance) {
		super(instance, 60);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HyenaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10466752, -12504798, new Item.Properties().group(AnimalExploItemGroup.tab))
				.setRegistryName("hyena_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 650, 1, 3));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.ROTTEN_FLESH, (int) (1)).getItem()), false));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, WolfEntity.class, false, true));
			this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, PlayerEntity.class, true, false));
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, ServerPlayerEntity.class, true, false));
		}
