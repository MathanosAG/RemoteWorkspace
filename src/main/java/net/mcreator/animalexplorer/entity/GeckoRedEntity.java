...
import net.mcreator.animalexplorer.entity.renderer.GeckoRedRenderer;
...
public class GeckoRedEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.9f, 0.6f)).build("gecko_red").setRegistryName("gecko_red");
	public GeckoRedEntity(AnimalexplorerModElements instance) {
		super(instance, 97);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GeckoRedRenderer.ModelRegisterHandler());
