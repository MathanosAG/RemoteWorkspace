...
import net.mcreator.animalexplorer.entity.renderer.GeckoGreenRenderer;
import net.mcreator.animalexplorer.AnimalexplorerModElements;

@AnimalexplorerModElements.ModElement.Tag
public class GeckoGreenEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.9f, 0.6f)).build("gecko_green").setRegistryName("gecko_green");
	public GeckoGreenEntity(AnimalexplorerModElements instance) {
		super(instance, 93);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GeckoGreenRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, WoodGolemEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, ZombieVillagerEntity.class, true, false));
