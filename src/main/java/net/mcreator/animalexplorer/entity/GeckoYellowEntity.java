...
import net.mcreator.animalexplorer.entity.renderer.GeckoYellowRenderer;
...
public class GeckoYellowEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.9f, 0.6f)).build("gecko_yellow").setRegistryName("gecko_yellow");
	public GeckoYellowEntity(AnimalexplorerModElements instance) {
		super(instance, 96);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GeckoYellowRenderer.ModelRegisterHandler());
