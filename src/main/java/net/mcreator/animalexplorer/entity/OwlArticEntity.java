...
import net.mcreator.animalexplorer.entity.renderer.OwlArticRenderer;
import net.mcreator.animalexplorer.AnimalexplorerModElements;

import java.util.Random;

@AnimalexplorerModElements.ModElement.Tag
public class OwlArticEntity extends AnimalexplorerModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1f))
					.build("owl_artic").setRegistryName("owl_artic");
	public OwlArticEntity(AnimalexplorerModElements instance) {
		super(instance, 57);
		FMLJavaModLoadingContext.get().getModEventBus().register(new OwlArticRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2500135, -5000269, new Item.Properties().group(AnimalExploItemGroup.tab))
				.setRegistryName("owl_artic_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 300, 1, 3));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(WormItem.block, (int) (1)).getItem()), false));
		}
